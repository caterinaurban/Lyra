from lyra.engine.assumption.assumption_analysis import TypeAnalysis, RangeAnalysis, \
    TypeRangeAssumptionAnalysis, TypeAlphabetAssumptionAnalysis
...
TypeAlphabetAssumptionAnalysis().main('/home/radwa/Lyra/src/lyra/unittests/character/substitution.py')