        ...
        for v in d1.values():
            ...
            if v <= v2:
                ...
                if inp in d2.keys():
                    ...
                    # STATE: inp -> [5, 6], v -> [2, 6], v1 -> [9, 9], v2 -> [6, 6], d1 -> {([2, 2], [2, 2]), ([3, 3], [8, 8]), ([5, 5], [10, 10]), ([9, 9], [12, 12])}, d2 -> {([-1, -1], [7, 12])}, d1 -> {([-inf, 1], True), ([4, 4], True), ([6, 8], True), ([10, inf], True)}, d2 -> {([-inf, inf], True)}, {(d1, None, v)}
                    d2[inp]: int = v
                    # STATE: inp -> [5, 6], v -> [2, 6], v1 -> [9, 9], v2 -> [6, 6], d1 -> {([2, 2], [2, 2]), ([3, 3], [8, 8]), ([5, 5], [10, 10]), ([9, 9], [12, 12])}, d2 -> {([-1, -1], [7, 12]), ([5, 6], [2, 6])}, d1 -> {([-inf, 1], True), ([4, 4], True), ([6, 8], True), ([10, inf], True)}, d2 -> {([-inf, inf], True)}, {(d1, None, v)}
                # STATE: inp -> [5, 6], v -> [2, 6], v1 -> [9, 9], v2 -> [6, 6], d1 -> {([2, 2], [2, 2]), ([3, 3], [8, 8]), ([5, 5], [10, 10]), ([9, 9], [12, 12])}, d2 -> {([-1, -1], [7, 12]), ([5, 6], [2, inf])}, d1 -> {([-inf, 1], True), ([4, 4], True), ([6, 8], True), ([10, inf], True)}, d2 -> {([-inf, inf], True)}, {(d1, None, v)}
                v1: int = v1
                # STATE: inp -> [5, 6], v -> [2, 6], v1 -> [9, 9], v2 -> [6, 6], d1 -> {([2, 2], [2, 2]), ([3, 3], [8, 8]), ([5, 5], [10, 10]), ([9, 9], [12, 12])}, d2 -> {([-1, -1], [7, 12]), ([5, 6], [2, inf])}, d1 -> {([-inf, 1], True), ([4, 4], True), ([6, 8], True), ([10, inf], True)}, d2 -> {([-inf, inf], True)}, {(d1, None, v)}
            else:
