...
class LatticeTest:
    """
    A class that provides some abstract tests for lattices.
    """

    @abstractmethod
    def default(self) -> 'Lattice':
        """ Returns the default element of the lattice.
    ...
    def elements(self) -> List['Lattice']:
        """ Returns a list of elements of the lattice.
...
class ArithmeticLatticeTest(LatticeTest):
    """
    A class that provides some abstract tests for arithmetic lattices.
    """
